...
def build_bug_bounty_hunting_flow(
    ...
    nodes = [
        ...
        _node(
            ...
            {"n": 5},
            category="agent_os",
            description="Jacky: sample 5 report candidates for verification scaling",
        ),
        _node(
            "n_verify",
            "self_verify",
            ...
            2200,
            80,
            {"min_score": 12.0, "block_if_low": False},
            category="agent_os",
            description="Jacky: rank candidates 1–20 and keep expected-best",
        ),
        _node(
            "n_rules",
            "verifiable_rules",
            ...
            {"fail_closed": False},
            category="agent_os",
            description="Voxyz: checkable instruction blocks, not wishful nevers",
        ),
        _node(
            "n_submit",
            "submission_gate",
        ...
        _node(
            ...
            180,
            {
                "idea": "Smallest live hunt package",
                "live_url": "https://elan7192.github.io/semantica/",
                "stack": "Python + semantica.flow + GitHub Pages Workshop",
            },
            category="agent_os",
    ...
    edges = [
        ...
        _edge("n_report", "n_sample"),
        _edge("n_sample", "n_verify"),
        _edge("n_verify", "n_rules"),
        _edge("n_rules", "n_submit"),
        _edge("n_submit", "n_ship", "ready"),
        _edge("n_ship", "n_export"),
    ]
